...
y_mean = tensor_data_train[1].mean()
y_std = tensor_data_train[1].std()
tensor_data_train[1] = (tensor_data_train[1] - y_mean) / y_std
tensor_data_val[1] = (tensor_data_val[1] - y_mean) / y_std
tensor_data_test[1] = (tensor_data_test[1] - y_mean) / y_std
...
model_nn = NNModel(p, ldim=1000, dropout_prob=0.5).to(device)
